...
public class ChatApplication extends Application implements Observable {
    ...
    public synchronized List<String> getFoundChannels() {
        ...
        List<String> clone = new ArrayList<>(mChannels.size());
     ...
     */
    private String mHostChannelName = null;
     ...
     */
    private List<ChatMessage> mOutbound = new ArrayList<>();
     ...
     * sent.
     */
    public synchronized ChatMessage getOutboundItem() {
     ...
     */
    private List<ChatMessage> mHistory = new ArrayList<>();
